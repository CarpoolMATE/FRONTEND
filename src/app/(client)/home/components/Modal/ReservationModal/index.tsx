          ...
          <div className="w-[335px] h-[431px] pt-[55px] flex-col justify-start items-start gap-[20px] inline-flex">
            <div className="self-stretch  flex-col justify-start items-start gap-[25px] flex">
              <div className="h-[62px] flex-col justify-start items-start gap-1 flex">
                <div className="w-[102px] text-[#b2b2b2] text-sm font-medium  leading-[14px] tracking-tight">
                  드라이버
                </div>
                  ...
                  <div className="self-stretch justify-start items-center inline-flex">
                    <div className="grow shrink basis-0 h-11 justify-start items-center gap-2 flex">
                      ...
                      <div className="grow shrink basis-0 flex-col justify-start items-start inline-flex">
                        <div className="text-[#3c3c3c] text-[15px] font-medium  leading-[14px]">
                          {'{이름}'}
                        </div>
                      </div>
                    </div>
                ...
                <div className="self-stretch flex-col justify-between items-start inline-flex">
                  <div className="self-stretch h-[71px] flex-col justify-start items-start gap-3 flex">
                    <div className="flex-col justify-start items-start gap-1.5 flex">
                      <div className="text-[#3c3c3c] text-base font-medium ">
                        홍대입구역 8번 출구
                      </div>
                    </div>
                    <div className="h-4 justify-start items-center gap-1.5 inline-flex">
                      ...
                      <div className="text-[#666666] text-sm font-medium  leading-[14px]">
                        오전 8시 30분
                      </div>
                    </div>
                  </div>
                  <div className="w-[66px] pb-0.5 justify-center items-center gap-2.5 inline-flex">
                    <div className="grow shrink basis-0 text-[#3c3c3c] text-base font-medium ">
                      OO대학교
                    </div>
                  </div>
                </div>
              ...
              <div className="self-stretch justify-start items-center inline-flex">
                <div className="grow shrink basis-0 flex-col justify-start items-start gap-2.5 inline-flex">
                  <div className="self-stretch text-[#b2b2b2] text-sm font-medium  leading-[14px] tracking-tight">
                    탑승 인원
                  </div>
                  <div className="self-stretch h-5 text-[#3c3c3c] text-[15px] font-medium  leading-[14px]">
                    4/4
                  </div>
                </div>
                <div className="grow shrink basis-0 flex-col justify-start items-start gap-2.5 inline-flex">
            ...
            <Link
              href={CLIENT_APP_ROUTES.CONFIRM_RESERVATION}
