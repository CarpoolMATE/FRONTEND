...
const UserDetailPage: React.FC = () => {
  ...
  return (
    <div className="w-screen h-screen">
      ...
      <div className="w-full bg-[#f7f7f7] h-screen pl-[200px]">
        <div className="flex justify-start bg-[#f7f7f7]  text-[#3c3c3c] text-4xl font-semibold font-['Pretendard'] leading-7 pt-[70px] mb-[50px]">
          상세 신고 내역
        </div>

        <div className="w-[1520px] h-[754px] flex-col justify-start items-start gap-[30px] inline-flex">
          <div className="self-stretch h-[696px] rounded-[10px] flex-col justify-start items-start gap-5 flex">
            <div className="self-stretch px-[100px] py-[30px] bg-white rounded-[10px] justify-start items-center gap-[150px] inline-flex">
            ...
            <div className="self-stretch h-[364px] px-[100px] py-[30px] bg-white rounded-[10px] flex-col justify-center items-start flex">
              ...
              <div className="self-stretch h-[168px] py-[30px] flex-col justify-start items-start gap-5 flex">
                ...
                <div className="self-stretch text-[#3c3c3c] text-xl font-normal font-['Pretendard'] leading-[30px]">
                  ...
                  3명이 모두 지각하게 되었습니다. 카풀 서비스의 신뢰도를
                  심각하게 훼손한 사례로, 이에 대한 적절한 조치가 필요합니다.
                </div>
              </div>
            </div>
          </div>
