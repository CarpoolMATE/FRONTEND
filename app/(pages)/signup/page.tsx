...
const SignupPage: React.FC = () => {
  ...
  const validateId = (value: string) => {
    ...
    return !(koreanPattern.test(value) || specialPattern.test(value));
  };
  ...
  return (
    <div className="relative w-full px-[20px] pt-[150px]">
      ...
      <div className="w-[335px] h-[410px] flex-col justify-start items-start  inline-flex">
      ...
      email ? (
        <div
          onClick={() => signUp()}
          className="w-[335px] h-[51px] px-[30px] py-[15px] cursor-pointer bg-[#007aff] rounded-xl justify-center items-center gap-2.5 inline-flex mt-[168px]"
        >
        ...
        <div className="w-[335px] h-[51px] px-[30px] py-[15px] bg-[#dadde1] rounded-xl justify-center items-center gap-2.5 inline-flex mt-[168px]">
