...
const SignupPage: React.FC = () => {
  ...
  // 비속어 체크 (예시 비속어 리스트 사용)
  function checkNotSlang(text: string): boolean {
    const slangList = ["비속어1", "비속어2", "비속어3"]; // 실제 비속어 리스트로 교체 필요
    return !slangList.some((slang) => text.includes(slang));
  }
  ...
  return (
    <div className="relative w-full px-[20px] pt-[150px]">
      ...
      <form onSubmit={handleSubmit}>
        <div className="w-[335px] h-full flex-col justify-start items-start  inline-flex">
          ...
          {idError ? (
            <div className="pl-[10px] text-[#e0302d] text-sm font-normal font-['Pretendard'] mt-[5px]">
              영문, 숫자 조합으로 작성해주세요
            </div>
          ) : (
            <div className="pl-[10px] text-[#e0302d] text-sm font-normal font-['Pretendard'] mt-[5px]"></div>
          )}
          ...
          <div className="self-stretch h-full flex-col justify-start items-start gap-2.5 flex mt-[25px]">
            ...
            <div className="flex items-center flex-wrap justify-start">
              ...
              {checkSpacing(name) && name ? (
                <div className="ml-[53.85px] mr-[10px] flex items-center gap-[10px]">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="9"
                    height="8"
          ...
          <div className="self-stretch h-[71px] flex-col justify-start items-start gap-2.5 flex mt-[25px]">
            <div className="px-2.5 justify-center items-center gap-2.5 inline-flex">
              <div className="text-[#4f4f4f] text-sm font-medium font-['Pretendard']">
                이메일
              </div>
            ...
            {emailError && email && (
              <div className="text-[#e0302d] text-sm font-normal font-['Pretendard']">
                이메일 형식을 준수해주세요
              </div>
            )}
          </div>
        ...
        email ? (
          <div
            ...
            className="w-[335px] h-[51px] px-[30px] py-[15px] cursor-pointer bg-[#007aff] rounded-xl justify-center items-center gap-2.5 inline-flex mt-[178px]"
          >
          ...
          <div className="w-[335px] h-[51px] px-[30px] py-[15px] bg-[#dadde1] rounded-xl justify-center items-center gap-2.5 inline-flex mt-[178px]">
