  ...
  return (
    <div className="relative w-full px-[20px] pt-[57.5px]">
      <div className="flex top-[57.5px]">
        ...
        <div className="w-full mt-[106px] text-center text-[#3c3c3c] text-2xl font-bold font-['Pretendard'] leading-[38.40px]">
          드라이버 정보를
          <br />
          성공적으로 등록했어요!
        </div>
      ...
      <div
        ...
        className="cursor-pointer mt-[85px] w-full flex gap-[8px] justify-center items-center"
      >
