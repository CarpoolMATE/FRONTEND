...
const RegisterCarPage: React.FC = () => {
  ...
  // Zustand store에서 첫 번째 전화번호와 설정 함수를 가져옵니다
  const { phone1: number, setPhone } = useVehicleStore();
  ...
  return (
    <div className="relative w-full px-[20px] pt-[57.5px]">
      <div className="flex top-[57.5px]">
        ...
        <div className="absolute left-[193.5px] top-[139.5px] w-[161.5px] h-[5px] bg-[#007aff] rounded-[15px]" />
      </div>
